...
sl = 606.5;
DP_c =[sl -P_310311 -P_306313 G5_0 G3_0 G6_0 -P_310311-P_306313+E1_0+E2_0-400];
...
while P_0_init(1) ~= P_0(1)
    ...
    if flag==0
        ...
        P_0(5) = 410.2;
        DP_c(5) = P_0(3);
        DP_c(7) = -P_310311-P_306313+P_0(4)+P_0(5)-400;
        flag = 1;
    else
        [DP_m(2:end,:), P_m(2:end,:), P_gen(2:end,:)] = Calc_new_P_m(D(2:end), f_n, sigma, P_N((2:end),:), P_0, PG_0, P_c0, DP_c(2:end));
        for i=1:length(DP_c)
