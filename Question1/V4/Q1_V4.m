...
P_N = [G1_N G2_N G3_N E1_N E2_N;
       ...
       G1_N G2_N G3_N E1_N E2_N;
       G1_N G2_N G3_N 0 0];
P_G = [G1_0 G2_0 G3_0 G4_0 G5_0 G6_0;
       G1_0 G2_0 G3_0 G4_0 G5_0 G6_0;
       G1_0 G2_0 G3_0 G4_0 0 G6_0;
       G1_0 G2_0 0 G4_0 G5_0 G6_0;
...
[DP_m(2:end,:), P_m(2:end,:), P_gen(2:end,:)] = Calc_new_P_m(D(2:end), f_n, sigma, P_N((2:end),:), P_0, P_G, P_c0_cc, P_load, DP_c(2:end));
for i=1:length(DP_c)
...
POW_E1 = P_gen(:,7);
POW_E2 = P_gen(:,8);
T_POW = table(EVENT,POW_G1, POW_G2, POW_G3, POW_G4, POW_G5, POW_G6, POW_E1, POW_E2);
